<?php
	...
	function booty_enqueue_scripts() {
		...
		// new jquery
		wp_enqueue_script('jquery', get_template_directory_uri() . 'theme/js/jquery.min.js', array(), '1.0', true);
		wp_enqueue_script('bootstrap', get_template_directory_uri() . 'theme/js/bootstrap.min.js', array(), '1.0', true);
